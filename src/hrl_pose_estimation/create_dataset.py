...
# import sys
sys.path.append('D:\workspace\python_ws\hrl-lib-indigo-devel\hrl_lib\src')  # 添加项目根目录到搜索路径

import hrl_lib.util as ut


# HRL libraries
# from ...hrl_lib.src.hrl_lib import util as ut
        ...
        # ,'RL']:
            ...
            #print self.training_dump_path
                ...
                #for [p_map_raw, target_raw, _] in p_file:
                    ...
                    lower_lengths_i.append(leg_joint_lengths)
                    upper_lengths_i.append(arm_joint_lengths)
                    lower_angles_i.append(leg_joint_angles)
                    upper_angles_i.append(arm_joint_angles)
                    angle_i.append(angle * 0.75)
                    #print arm_joint_angles[0], arm_joint_angles[2],'arm joint angles'
